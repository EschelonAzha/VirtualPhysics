...
class Conductor : IConductor {
    ...
    override fun conductor_(atom: symmetrical.physics.atomic.atoms.Atom, autoFlow:Boolean) : symmetrical.physics.atomic.atoms.Atom {
        conductor(atom, autoFlow);
        return atom
    }
    override fun _conductor(atom: symmetrical.physics.atomic.atoms.Atom, autoFlow:Boolean) : symmetrical.physics.atomic.atoms.Atom {
        conductor(atom, autoFlow);
        return this.atom
    }
    override fun conductor(atom: symmetrical.physics.atomic.atoms.Atom, autoFlow:Boolean) : Unit {
