...
// For more information visit:   https://en.wikipedia.org/wiki/Positron

class Positron (
    private val matterAntiMatter: IAntiMatter = AntiMatter().with(symmetrical.physics.subatomic.anti_matter.anti_leptons.Positron::class),
