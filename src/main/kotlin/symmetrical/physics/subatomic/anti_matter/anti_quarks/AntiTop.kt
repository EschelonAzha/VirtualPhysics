...
import symmetrical.physics.subatomic.matter.quarks.Top

// For more information visit:   https://en.wikipedia.org/wiki/TopQuark


class AntiTop(
    private val matterAntiMatter: IAntiMatter = AntiMatter().with(symmetrical.physics.subatomic.anti_matter.anti_quarks.AntiTop::class),
